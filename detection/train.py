...
def visualize_gt(train_dataset, val_dataset):
    writer = SummaryWriter("Detection_Logs//Visualize_GT")
...
def main(args):
    ...
    if args.overfit and not args.inference:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--overfit", type=bool, default=True, action=argparse.BooleanOptionalAction
    )
    parser.add_argument(
        "--inference", type=bool, default=False, action=argparse.BooleanOptionalAction
    )
    parser.add_argument(
        "--test_inference", type=bool, default=False, action=argparse.BooleanOptionalAction
    )
